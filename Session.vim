...
inoremap <M-Right> :tabni
inoremap <M-Left> :tabpi
inoremap <C-S> :wi
inoremap <C-A> ggVG$
inoremap <M-N> :tabe
inoremap <expr> <C-L> &relativenumber == 1 ? ':set number:set norelativenumberi' : ':set relativenumber:set numberi'
nnoremap  ggVG$
vmap  "+y
nnoremap <expr>  &relativenumber == 1 ? ':set number:set norelativenumber' : ':set relativenumber:set number'
nnoremap  :w
vmap  yy"+p
...
vmap <C-C> "+y
vmap <C-V> yy"+p
nnoremap <M-Right> :tabn
nnoremap <M-Left> :tabp
nnoremap <C-S> :w
nnoremap <C-A> ggVG$
nnoremap <M-N> :tabe 
nnoremap <expr> <C-L> &relativenumber == 1 ? ':set number:set norelativenumber' : ':set relativenumber:set number'
inoremap  ggVG$
inoremap <expr> 	 pumvisible() ? "\" : "\	"
inoremap <expr>  &relativenumber == 1 ? ':set number:set norelativenumberi' : ':set relativenumber:set numberi'
inoremap  :wi
...
silent! normal! zE
let &fdl = &fdl
let s:l = 695 - ((24 * winheight(0) + 25) / 50)
...
silent! normal! zE
let &fdl = &fdl
let s:l = 188 - ((49 * winheight(0) + 25) / 50)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 188
...
silent! normal! zE
let &fdl = &fdl
let s:l = 159 - ((0 * winheight(0) + 25) / 50)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 159
